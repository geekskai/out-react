...
var render = function render(element, container) {
  ...
  if (["string", "number"].includes(_typeof(element))) {
    container.appendChild(document.createTextNode(element));
    return;
  }

  var dom = document.createElement(element.tag);
  (_a = Object.keys(element.props)) === null || _a === void 0 ? void 0 : _a.filter(function (prop) {
    return prop !== "children";
  }).forEach(function (key) {
    dom[key] = element.props[key];
  });
  (_b = element.props.children) === null || _b === void 0 ? void 0 : _b.forEach(function (child) {
